...
**使用后下一步**：人工补齐 `docs/env/local-env.md` 中的确认项；随后先用 `ai/prompts/docs/01-review-inputs.md` 评审输入材料，再用 `ai/prompts/docs/00-generate-or-complete-docs.md` 生成 / 更新 docs 文档体系，并要求技术方案读取该文件。
