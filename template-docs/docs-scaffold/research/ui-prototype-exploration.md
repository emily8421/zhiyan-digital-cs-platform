...
> 对应规则：`ai/document-lifecycle-rules.md` §10.2、`ai/prompts/docs/22-ui-prototype-exploration.md`
> 定位：正式 `00-03` 定稿前的需求探索 / 用户确认辅助材料；不是需求权威源，不替代架构、技术方案、前端交互设计或验收记录。
