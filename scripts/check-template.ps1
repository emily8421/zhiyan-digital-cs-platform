...
function Invoke-NativeTemplateCheck {
  ...
  Require-Contains "scripts/sync-template.sh" "if \[\[ -f TEMPLATE-BASE\.md \]\]" "sync-template auto-detects TEMPLATE-BASE lineage mode"
  ...
  Require-Contains "scripts/sync-template.ps1" 'preserveProjectVersion = \$true' "sync-template PowerShell fallback auto-detects TEMPLATE-BASE lineage mode"
