...
- Base template version: v1.46.0
- Current synced template version: v1.52.4
...
- Template sync commits keep the message format `sync template v1.52.4 from ai-project-template`.